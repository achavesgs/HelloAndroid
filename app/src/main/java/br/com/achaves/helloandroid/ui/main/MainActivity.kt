package br.com.achaves.helloandroid.ui.main
...
import br.com.achaves.helloandroid.ui.checkout.CheckoutActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cbPortuguesa.setOnCheckedChangeListener { buttonView, isChecked ->
            mainViewModel.portuguesaSelecionada = isChecked
        }
